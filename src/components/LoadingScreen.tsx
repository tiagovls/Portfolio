...
export default function LoadingScreen() {
  ...
  useEffect(() => {
    ...
    if (path) {
      ...
      gsap.to(path, {
        ...
        ease: "power1.inOut",
        onComplete: () => {
          // Automatic exit after animation
  ...
  return (
    <div ref={containerRef} className="preloader" style={{ background: '#000', zIndex: 9999 }}>
      <div className="preloader-content relative flex flex-col items-center justify-center h-full w-full">
        <div className="z-10 flex flex-col items-center w-full max-w-[480px] px-8">
          {/* Apple Style "hello" SVG */}
          <svg 
            ref={svgRef}
            viewBox="-440 -600 1400 700" 
            fill="none" 
